...
namespace Hotel_Bilyana.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationModelReservationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReservationModel_ClientModel_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomModel_ReservationModel_ReservationModelReservationId",
                        column: x => x.ReservationModelReservationId,
                        principalTable: "ReservationModel",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientModel_ReservationModelReservationId",
                table: "ClientModel",
                column: "ReservationModelReservationId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationModel_ClientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomModel_ReservationModelReservationId",
                table: "RoomModel",
                column: "ReservationModelReservationId");

            migrationBuilder.AddForeignKey(
                name: "FK_ClientModel_ReservationModel_ReservationModelReservationId",
                table: "ClientModel",
                column: "ReservationModelReservationId",
                principalTable: "ReservationModel",
                principalColumn: "ReservationId");
